        ...
        if (member.roles.cache.get(guildData.rank4.id)) {
            ...
            await i.reply({
                embeds: [
                    new Discord.MessageEmbed()
                        .setTitle(`Progress of <@${userId}> in ${guildData.emoji} ${guildName} ${guildData.emoji} WOOHOOO!`)
                        .setDescription(`**Current rank:** ${guildData.rank4.name}!\n\n**Progress towards ${guildData.rank5.name}:** <a:loadinggg:996842291593486346>\n${userData.pointsTotal}**/${guildData.rank5.points}** points\n${level5[0].points}**/${400}** points from Excellent quality builds of any size`),
                ],
            });
        }
            ...
            await i.reply({
                embeds: [
                    new Discord.MessageEmbed()
                        .setTitle(`Progress of <@${userId}> in ${guildData.emoji} ${guildName} ${guildData.emoji} WOOHOOO!`)
                        .setDescription(`**Current rank:** ${guildData.rank3.name}\n\n**Progress towards ${guildData.rank4.name}:** <a:loadinggg:996842291593486346>\n${userData.pointsTotal}**/${guildData.rank4.points}** points\n${largeOrMediums[0].points}**/${200}** points from Good/Excellent quality Medium/Large builds`),
                ],
            });
        }
            ...
            await i.reply({
                embeds: [
                    new Discord.MessageEmbed()
                        .setTitle(`Progress of <@${userId}> in ${guildData.emoji} ${guildName} ${guildData.emoji} WOOHOOO!`)
                        .setDescription(`**Current rank:** ${guildData.rank2.name}\n\n**Progress towards ${guildData.rank3.name}:**\n${userData.pointsTotal}**/${guildData.rank3.points}** points\n${largeOrMediums[0].points}**/${100}** points from Good/Excellent quality Medium builds`),
                ],
            });
        }
